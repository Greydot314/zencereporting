...
export const Header = () => {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 h-14 border-b border-border/50 glass-strong">
      <div className="h-full flex items-center justify-between px-4 gap-4">
        {/* Left: Logo & Trigger */}
        <div className="flex items-center gap-3">
          <SidebarTrigger className="h-8 w-8 text-muted-foreground hover:text-foreground" />
          <Link to="/" className="flex items-center gap-2">
            <div className="w-7 h-7 rounded-lg gradient-primary flex items-center justify-center ai-glow">
        ...
        <Link to="/ai-chat" className="flex-1 max-w-lg">
          <div className="relative group">
            ...
            <div className="h-10 pl-10 pr-4 bg-secondary/50 border border-border/50 rounded-xl flex items-center gap-2 group-hover:border-primary/30 group-hover:bg-secondary/70 transition-all cursor-pointer">
        ...
        <div className="flex items-center gap-1">
          <Button variant="ghost" size="icon" className="relative h-9 w-9 text-muted-foreground hover:text-foreground hover:bg-secondary/50">
